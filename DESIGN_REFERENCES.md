...
The shopping-list implementation is governed by its persisted surface brief and
the shared design system. No standalone directory under `redesigns/` is
currently designated as its authority.
