...
Future<Uint8List> getRecipeCalendarPdf(
  Map<DateTime, List<String>> calendarEntries,
            ...
            for (DateTime key in calendarEntries.keys.toList()) {
              if (key.weekday == index + 1) {
                for (String recipeName in calendarEntries[key]!.toList()) {
                  weekDayRecipes.add(Tuple2<DateTime, String>(key, recipeName));
                }
              }
            }
            if (index < 7) {
                            ...
                            return pw.Container(
                              ...
                              child: pw.Padding(
                                ...
                                child: pw.Column(
                                  mainAxisSize: pw.MainAxisSize.min,
                                  children: [
                                    weekDayRecipes[recipeIndex].item1.hour ==
                                                0 &&
                                    ...
                                    pw.Text(weekDayRecipes[recipeIndex].item2),
              ...
              return pw.Container(
                ...
                child: pw.Column(
                  mainAxisSize: pw.MainAxisSize.min,
                  mainAxisAlignment: pw.MainAxisAlignment.center,
                  children: [pw.Text(S.of(bContext).notes)]
                    ..addAll(
                      List.generate(
                        10,
                        (i) => pw.Container(
