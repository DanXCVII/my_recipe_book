...
class RecipeCalendarFloating extends StatefulWidget {
  ...
  RecipeCalendarFloating({required this.initialPosition, Key? key})
    : super(key: key);
      ...
      Padding(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Stack(
              children: <Widget>[
                RecipeCalendarContent(height: height, width: width),
                Align(
                  ...
                  child: Container(
                    ...
                    child: BlocBuilder<RecipeCalendarBloc, RecipeCalendarState>(
