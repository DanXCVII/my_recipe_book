          ...
          builder: (context, state) {
            if (state is LoadedIngredientsSection) {
              return Column(
                ...
                children:
                    List<Widget>.generate(state.ingredients.length, (index) {
                      return Column(
                        children:
                            [
                                ReorderableColumn(
                                  ...
                                  onReorder: (oldIndex, newIndex) {
                                    BlocProvider.of<IngredientsSectionBloc>(
                                      ...
                                      MoveIngredient(index, oldIndex, newIndex),
                                    );
                                  },
